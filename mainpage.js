...
$(document).ready(function() {
  ...
  CustomButton = $('#content-main > div:nth-child(4) > h2').append('<div class="dropdown"><button class="btn btn-primary dropdown-toggle" id="menu1" type="button" data-toggle="dropdown" aria-expanded="false">Themes&nbsp;<span style="font-size:15px">&#8661</span><ul class="dropdown-menu" role="menu" aria-labelledby="menu1"><li role="presentation"><a role="menuitem" tabindex="-1">Header Color<ul style="list-style-type:none"></li><input type="hidden" id="headerColor"></ul></a></li><li role="presentation"><a role="menuitem" tabindex="-1" href="#">Text Color<ul style="list-style-type:none"></li><input type="hidden" id="text"></ul></a></li><li role="presentation"><a role="menuitem" tabindex="-1" href="#">Tab Color<ul style="list-style-type:none"></li><input type="hidden" id="tabs"></ul></a></li><li role="presentation"><a role="menuitem" tabindex="-1" href="#">Alternative Color<ul style="list-style-type:none"></li><input type="hidden" id="alt"></ul></a></li><li role="presentation"><a role="menuitem" tabindex="-1" href="#">Background Color<ul style="list-style-type:none"></li><input type="hidden" id="background"></ul><li role="presentation" class="divider"></li><li role="presentation"><<a role="menuitem" tabindex="-1" id = "defaultButton">Default Theme</a></li><li role="presentation"><a role="menuitem" tabindex="-1" id = "customButton">Custom Theme</a></li><li role="presentation"><a role="menuitem" tabindex="-1" id = "theme1Button">Blue and Gray</a></li> </ul></div></div>');
  //<div class="dropdown"><button class="btn btn-primary dropdown-toggle" id="menu1" type="button" data-toggle="dropdown">Themes &nbsp;<span style="font-size:15px">&#8661</span></button><ul class="dropdown-menu" role="menu" aria-labelledby="menu1"><li role="presentation"><a role="menuitem" tabindex="-1" href="#">Header Color<ul style="list-style-type:none"></li><input type="hidden" id="headerColor"></ul></a></li><li role="presentation"><a role="menuitem" tabindex="-1" href="#">Text Color<ul style="list-style-type:none"></li><input type="hidden" id="text"></ul></a><li style="list-style-type:none" role="presentation"><a role="menuitem" tabindex="-1">Tab Color<ul style="list-style-type:none"></li><input type="hidden" id="tabs"></ul></a><li style="list-style-type:none" role="presentation"><a role="menuitem" tabindex="-1">Alternative Color<ul style="list-style-type:none"></li><input type="hidden" id="alt"></ul></a><li style="list-style-type:none" role="presentation"><a role="menuitem" tabindex="-1">Background Color<ul style="list-style-type:none"></li><input type="hidden" id="background"></ul></a><li role="presentation"><a role="menuitem" tabindex="-1" id = "defaultButton">Default Theme</a></li><li role="presentation"><a role="menuitem" tabindex="-1" id = "customButton">Custom Theme</a></li><li role="presentation"><a role="menuitem" tabindex="-1" id = "theme1Button">Blue and Gray</a></li> </ul></div></div>');
